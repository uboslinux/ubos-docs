...
imageDiv.innerHTML = '<a href="UBOS_AWS_IMAGE_URL"><img src="https://ubos.net/images/ubos-on-aws.png" alt="[EC2 image]" style="padding: 10px; border-radius: 5px; border: #a0a0a0 1px solid"/></a>';
